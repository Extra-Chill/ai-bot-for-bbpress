...
class System_Prompt_Builder {
    ...
    public function build_system_prompt( $bot_username ) {
      ...
      */
     public function build_response_instructions( $bot_username, $triggering_username_slug ) {
         return sprintf(
             ...
             "3. Use information from 'RELEVANT KNOWLEDGE BASE (LOCAL)' to answer the query, if it contains relevant information.\n".
             ...
             "6. Cite the source URL (if provided in the context) primarily when presenting specific facts, figures, or direct quotes from the 'RELEVANT KNOWLEDGE BASE (LOCAL)' section to support your response.\n".
